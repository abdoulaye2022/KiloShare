...
if(!isset($params['id']) || !isset($data['description']) || !isset($data['space_available']) || !isset($data['price_kilo']) || !isset($data['price_per_kilo']) ||
    ...
    empty($params['id']) || empty($data['description']) || empty($data['space_available']) || empty($data['price_kilo']) || empty($data['departure_city']) || 
