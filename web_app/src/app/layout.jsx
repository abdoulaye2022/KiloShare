...
// Définition de la police locale (si nécessaire)
// const myFont = localFont({
//   src: "../public/fonts/Roboto-Regular.ttf", // Remplacez par le chemin de votre police
//   display: "swap",
// });
...
export default async function RootLayout({ children }) {
  ...
  return (
    <html lang={locale}>
      <Head>
        {/* Balise meta viewport pour le responsive design */}
        <meta
          name="viewport"
        ...
        {/* Thème de couleur pour les navigateurs mobiles */}
